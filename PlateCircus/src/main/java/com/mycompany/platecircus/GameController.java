...
public final class GameController {
	...
	menuDiff.add(newEasyMenuItem);
        menuDiff.add(newMedMenuItem);
        menuDiff.add(newHardMenuItem);
...
//                gameController.changeWorld(new StarWar(800, 600));
    ...
    public void start() {
        ...
        this.gameController = GameEngine.start("Plate Circus", game, menuBar, Color.WHITE);
